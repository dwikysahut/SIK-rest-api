...
module.exports = {
  getAllTahunAjaran: promiseHandler(async (req, res, next) => {
    ...
    return helpers.response(res, 200, 'Get All Tahun Ajaran Successfully', result);
  }),
  getTahunAjaranById: promiseHandler(async (req, res, next) => {
    ...
    return helpers.response(res, 200, 'Get Tahun Ajaran By ID Successfully', result);
  }),
  getTahunAjaranByProdi: promiseHandler(async (req, res, next) => {
    ...
    return helpers.response(res, 200, 'Get Tahun Ajaran By Prodi Successfully', result);
  }),
