...
module.exports = {
  ...
  laporanJurnalUmum: promiseHandler(async (req, res, next) => {
    ...
    const resultKreditPrev = await creditModel.getAllKreditSubmittedWithDate(true, '', tanggal_awal, tanggal_akhir, unit_id);
    ...
    const resultKredit = await creditModel.getAllKreditSubmittedWithDate(false, '', tanggal_awal, tanggal_akhir, unit_id);
